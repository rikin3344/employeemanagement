  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          EmployeesModel employeesModel = snapshot.data as EmployeesModel;
          return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    width: width * 0.9,
                    child: Column(
                      children: employeeList(employeesModel.data, width),
                    ),
                  )
                ],
              ),
...
List<Widget> employeeList(List<Datum> data, width) {
  List<Widget> element = [];
  for (var i = 0; i < data.length; i++) {
    String companyName = data[i].companyName;
    element.add(InkWell(
      onTap: () {},
      child: Container(
        width: width * 0.9,
